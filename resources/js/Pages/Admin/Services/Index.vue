      ...
      <div class="card">
        ...
        >
          ...
          <Column
            ...
            header-style="width:5%; min-width:8rem;"
          >
            <template #body="slotProps">
        ...
        >
          ...
          <div class="formgrid grid">
            <div class="field col">
              ...
              <InputText
                id="min_price"
                v-model="record.min_price"
                name="min_price"
                :class="{ 'p-invalid': submitted && (errors && errors.min_price || !record.min_price) }"
              />
              <small
                class="p-error"
                v-if="submitted && errors && errors.min_price"
              >{{ errors.min_price
              }}</small>
              <small
                class="p-error"
                v-if="submitted && !record.min_price"
              >Minimum Price is required</small>
            </div>
            <div class="field col">
              <label for="max_price">Maximum Price</label>
              <InputText
                id="max_price"
                v-model="record.max_price"
                name="max_price"
                :class="{ 'p-invalid': submitted && (errors && errors.max_price || !record.max_price) }"
              />
              <small
                class="p-error"
                v-if="submitted && errors && errors.max_price"
              >{{ errors.max_price
              }}</small>
              <small
                class="p-error"
                v-if="submitted && !record.max_price"
